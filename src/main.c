...
static char weather_ar_temp_layer_buffer[80];///string from JS
static char weather_ar_hour_buffer[50];///4*10 = 40?
static char weather_ar_wspd_buffer[50];///4*10 = 40?
static char weather_ar_condition_buffer[50];///4*10 = 40?
